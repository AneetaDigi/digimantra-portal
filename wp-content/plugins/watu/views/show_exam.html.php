...
<form action="twt" method="post" class="quiz-form" id="quiz-<?php echo $exam_id?>" <?php if(!empty($exam->no_ajax)):?>onsubmit="return Watu.submitResult(this)"<?php endif;?>>
<?php
...
//}
		     //window.location.href = 'https://schedul.in/thank-you/'; 
